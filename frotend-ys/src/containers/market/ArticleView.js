            ...
            <div className="articleView_wrapper">
                <div className="articleView_card">
                    <div className="articleView_card_img">
                        ...
                        <img src={`http://localhost:4000/` + articleView.image.path} alt="" />
                    </div>
                    <div className="articleView_card_details">
                       <h2 className="precion_ahora">{articleView.name}</h2>
                        ...
                        {
                           articleView.offer 
                            ? <div> <h4 className="precion_ahora">${articleView.sellPriceOffer}  (% {articleView.offer.percent} de Descuento)</h4>  </div>
                            : <h4 className="precion_ahora">${articleView.sellPrice} </h4>
                        }
                        
                    </div>
                    <div className="articleView_card_icons">
                        <div>
                            <ButtonItemView onClick={cancelModal} icon={<i class="fas fa-undo-alt"></i>}></ButtonItemView>
                            </div>
                            <div>
                            <ButtonItemView onClick={addArticleTrolley} icon={<i class="fas fa-check"></i>}></ButtonItemView>
                        </div>
                    </div>
                </div>
            </div>
