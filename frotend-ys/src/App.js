                    ...
                    <div className='app-container'>
                        <Router>
                            ...
                            <Switch>
                                ...
                                <PrivateRoute exact path="/tipoarticulo" component={ArticleType} />
                                <PrivateRoute exact path="/articulo" component={Articule} />
                                ...
                                <PrivateRoute exact path="/comprobantes" component={Receipts} />
                                <PrivateRoute exact path="/comprobantesadmin" component={ReceiptsAdmin} />
                                <PrivateRoute exact path="/creararticulo" component={NewArticule} />
                                <PrivateRoute exact path="/ofertas" component={Offers} />
                                <Route exact path="/escritorio" component={Delivery} />
