...
const ClientState = (props) =>{
    ...
    const { handleModal, cerrarSesion, setMessage,getConfiguration } = appContext;
    ...
    const closeSesion = async ()=>{
        ...
        await clienteAxios.post('/clientestrolley',{client:state.client ,trolleyClient:state.trolley});
        dispatch({
