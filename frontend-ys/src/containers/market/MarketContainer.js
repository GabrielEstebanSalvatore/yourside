...
const MarketContainer = () => {
    ...
    const {addArticleView,handleModal,showModal,articles,getArticles,} = appContext;    
        ...
        <div className="mercado">
            <div className="mercado_header">
                ...
                <div className="mercado_header_bottom ">
                    <p>Ir a ventas: </p>
                    <ButtonItemView onClick={()=>buyTrolley()} icon={<i class="fas fa-check-double"></i>}></ButtonItemView>
                </div> 
