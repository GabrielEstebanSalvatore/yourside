    ...
    return (
        <div className='pucharse'>
            ...
            <div className="pucharse_client_total">
                <h2>TOTAL:{
                    trolley.map(articulo => (
                        contador += articulo.sellPrice
                    )), <p>{`$ ${contador}`}</p>}
            ...
            <div class="pucharse_client_footer">
                <div className="backtomarket">
                    <Link class="btn btn-info" to="/mercado">Seguir comprando</Link>
                </div>
                <div className="pucharse">
                    <button class="btn btn-success" onClick={() => ToBuy()}>Realizar compra</button>
                </div>
            </div>
        </div>
