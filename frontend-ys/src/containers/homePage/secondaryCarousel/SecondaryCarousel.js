          ...
          <SwiperSlide > 
            <div className="article_carrouselsecundary">
              ...
              <div className="article_carrouselsecundary_image">
                {
                  article.image &&
                  <img src={`http://localhost:4000/` + article.image.path} alt="" />
                }
              ...
              <div className="article_carrouselsecundary_detail">
                ...
                <p>Precio venta:<strong> ${article.sellPrice}</strong></p>
                <p>Tipo: <strong>{article.articleType.name}</strong></p>
                  <ButtonPrincipal onClick={() => agregarCarrito(article)} title={'Comprar'}></ButtonPrincipal>
              </div>
